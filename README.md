...
This repository is **public for collaboration purposes only.**

- You may **not** use, run, deploy, or host any part of PRISM without explicit written permission from the owner.
- You may **not** fork this repository for personal deployment, private use, research, or commercial use.
- Contributions via **pull request only.** A submitted PR grants no rights to the codebase.
- No licence is granted by this repository being public. All rights reserved.
- Viewing for educational purposes is permitted. Deployment is not.

Full terms: [Licence & Legal](#licence--legal)
...
Pull requests only. Before submitting, open an issue to discuss the change.

- Contributions must align with PRISM's core principles.
- Do not submit PRs introducing cloud inference, external API dependencies for core functionality, or new cross-agent memory write exceptions.
- All contributions are subject to review and may be rejected.
- Submitting a PR grants no rights to this codebase. All contributions are licensed back to the project owner under the same restrictive terms.
...
Copyright © 2026 Viper. All rights reserved.

**You are NOT permitted to:**
- Use, run, deploy, or host any part of PRISM — in whole or in part — without explicit written permission from the owner.
- Fork this repository for deployment, personal use, commercial use, or research.
- Copy, redistribute, sublicense, sell, or transfer any part of this codebase.
- Incorporate any part of this codebase into another project without explicit written permission.
- Remove attribution or represent this project as your own.

**You are permitted to:**
- View and read code and documentation for educational purposes.
- Fork solely to submit a pull request. The fork may not be used for any other purpose.
- Submit pull requests for review.

No licence is granted by this repository being public. Public visibility is not a waiver of copyright.

---

*PRISM — Private Residential Intelligence System Matrix | Owner: Viper | 2026*
